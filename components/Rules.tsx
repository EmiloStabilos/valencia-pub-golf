  ...
  return (
    <div className={`${compact ? 'space-y-5' : 'px-6 py-6 space-y-7'}`}>
      ...
      <section className="space-y-2">
        <p className="smallcaps-ink border-b border-rule pb-1.5">Spillet</p>
      ...
      <section className="space-y-3">
        <p className="smallcaps-ink border-b border-rule pb-1.5">Sådan scorer du</p>
      ...
      {/* Section 3 — Example */}
      <section className="space-y-3">
        <p className="smallcaps-ink border-b border-rule pb-1.5">Eksempel — gennemsnit 4.0</p>
        <div className="border border-rule">
      ...
      {/* Section 4 — Strategy */}
      <section className="space-y-2">
        <p className="smallcaps-ink border-b border-rule pb-1.5">Strategien</p>
        <ul className="font-sans text-ink-secondary text-base space-y-1.5 leading-snug list-none">
      ...
      <section className="space-y-2">
        <p className="smallcaps-ink border-b border-rule pb-1.5">Drak du den faktisk på det meldte antal tårer?</p>
        <p className="font-sans text-ink-secondary text-base leading-snug">
      ...
      <section className="space-y-2">
        <p className="smallcaps-ink border-b border-rule pb-1.5">Straf-shots (drikke, ikke point)</p>
        <p className="font-sans text-ink-secondary text-base leading-snug">
